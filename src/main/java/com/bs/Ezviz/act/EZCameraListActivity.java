...
import com.bs.Ezviz.ActivityUtils;
import com.bs.Ezviz.EZUtils;
import com.bs.Ezviz.PullToRefresh.EZCameraListAdapter;
import com.bs.Ezviz.PullToRefresh.IPullToRefresh;
import com.bs.Ezviz.PullToRefresh.LoadingLayout;
import com.bs.Ezviz.PullToRefresh.PullToRefreshBase;
import com.bs.Ezviz.PullToRefresh.PullToRefreshFooter;
import com.bs.Ezviz.PullToRefresh.PullToRefreshHeader;
import com.bs.Ezviz.PullToRefresh.PullToRefreshListView;
import com.bs.Ezviz.RemoteListContant;
import com.bs.Ezviz.SelectCameraDialog;
import com.bs.Ezviz.WaitDialog;
import com.bs.Ezviz.zxing.CaptureActivity;
import com.bs.R;
...
import static com.bs.base.BaseApplication.getOpenSDK;
...
public class EZCameraListActivity extends BaseActivity implements View.OnClickListener, SelectCameraDialog.CameraItemClick {
    ...
    String tag="EZCameraListActivity";
    /**
     * 删除设备
     */
            ...
            switch (errorCode) {
                ...
                default:
                    if (mAdapter.getCount() == 0) {
                        ...
                        /*如果错误码为400902代表accesstoken过期提示用户重新登录获取*/
                        if(errorCode==400902){
                            mCameraFailTipTv.setText("请点击左上角头像重新登录");
                        }
