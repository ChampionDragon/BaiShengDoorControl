...
/*
 cmd:当发心跳报的时候设为1，发指令则按协议    MSG_DEV_SET_POWER = 101,MSG_GET_GATESTATE	102
 MSG_SET_GATESTATE=103  //1：OPEN ,CLOSE:0，STOP:2 ,CIRCLE:3
 MSG_SET_WINDFANSTATE=105
 param格式gate=？    问号对应上面相关操作       如：gate=0 关的操作
 */
