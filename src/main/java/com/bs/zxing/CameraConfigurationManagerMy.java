...
final class CameraConfigurationManagerMy {

	private static final String TAG = CameraConfigurationManagerMy.class
			.getSimpleName();
	...
	CameraConfigurationManagerMy(Context context) {
	...
	private void setFlash(Camera.Parameters parameters) {
		...
		// CameraManagerMy.SDK_INT == Build.VERSION_CODES.CUPCAKE) {
		if (Build.MODEL.contains("Behold II") && CameraManagerMy.SDK_INT == 3) { // 3
			// =
			// Cupcake
